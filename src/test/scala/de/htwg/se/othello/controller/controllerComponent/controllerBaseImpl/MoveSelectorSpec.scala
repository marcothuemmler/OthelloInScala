...
class MoveSelectorSpec extends WordSpec with Matchers {
  ...
  implicit val ctrl = new Controller
  ...
  "An EasyBot" should {
    "select a bad move using the search algorithm if the board size is 8x8" in {
      val moveSelector = new EasyBot
      ctrl.createBoard(8)
      ctrl.setBoard(ctrl.getBoard.flipLine((4, 3), (2, 3))(1))
      ctrl.getBoard.flipLine((2, 4), (2, 4))(2)
      ctrl.setBoard(ctrl.getBoard.flipLine((4, 4), (4, 5))(1))
      ctrl.setBoard(ctrl.getBoard.flipLine((3, 4), (5, 4))(2))
      val selection = moveSelector.selection
