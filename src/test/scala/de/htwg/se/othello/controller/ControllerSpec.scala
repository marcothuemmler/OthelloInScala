...
class ControllerSpec extends WordSpec with Matchers {
  ...
  "highlight " should {
    "highlight settable squares" in {
      c.highlight()
      c.board.grid(3)(2).value should be(-1)
    }
  }
  "getMoves" should {
